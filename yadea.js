const qdArr = [
  ...
  // `curl -H 'Host: 100000800589.retail.n.weimob.com' -H 'Cookie: pluto=L_78jtore3DER4Svne0IIeo64_EYdeiT; rprm_cuid=547913837f692cgogook; LIVE_MIN_CODE=; rprm_appShowId2=-kkc20ootjbv74u58rk; saas.express.session=s%3AL_78jtore3DER4Svne0IIeo64_EYdeiT.JlXajerh1J9hnrn2yVg%2FrvpjDSzdfopabPd3NAp3Nvo' -H 'content-type: application/json; charset=utf-8' -H 'pragma: no-cache' -H 'accept: application/json' -H 'weimob-wid: 2288382212' -H 'accept-language: zh-cn' -H 'cache-control: no-cache' -H 'origin: https://100000800589.retail.n.weimob.com' -H 'user-agent: Mozilla/5.0 (Macintosh; Intel Mac OS X 10_13_6) AppleWebKit/605.1.15 (KHTML, like Gecko) MicroMessenger/6.8.0(0x16080000) MacWechat/2.6.1(0x12060190) NetType/WIFI WindowsWechat' -H 'referer: https://100000800589.retail.n.weimob.com/saas/retail/100000800589/2172935589/market/signforward/index?shareChannel=1&rsShareWid=2288382212&sdp_ticketid=1_11_hm39ci&tuike_id=2288382212' -H 'weimob-pid: 100000800589' --data-binary '{"pid":"100000800589","storeId":2172935589,"wid":"2288382212","refer":"sign","source":2}' --compressed 'https://100000800589.retail.n.weimob.com/api3/misc/sign/activity/c/sign'`,
];
...
const qdUrl = 'https://100000800589.retail.n.weimob.com/api3/misc/sign/activity/c/sign'
...
function postMessage (url, data) {
  axios({
    ...
    headers: {
      ...
      'weimob-pid': 100000800589,
      'weimob-wid': 2288382212,
      'Cookie': 'pluto=L_78jtore3DER4Svne0IIeo64_EYdeiT; rprm_cuid=547913837f692cgogook; LIVE_MIN_CODE=; rprm_appShowId2=-kkc20ootjbv74u58rk; saas.express.session=s%3AL_78jtore3DER4Svne0IIeo64_EYdeiT.JlXajerh1J9hnrn2yVg%2FrvpjDSzdfopabPd3NAp3Nvo'
    },
    data:data
  }).then(res => {
